...
# Implement the sequential importance sampling algorithm of 
# Blitstein and Diaconis and estimate the number of graphs with 
# degree sequence given by the (unweighted) Karate Club network.

# Ref: Blitzstein, Joseph, and Persi Diaconis. “A sequential importance sampling algorithm for generating random graphs with prescribed degrees.” Internet mathematics 6.4 (2011): 489-522.
